...
<?php $this->load->view('backend_view/include/aside') ?>     
     ...
     <h3><i>Edit company Record</i></h3>
   
 
      <div class="xs">
       
        <div class="  well1 white">
        <form role="form" method="post" action="<?php echo base_url('backend/update_companies') ?>">
          <fieldset>
            <div class="col-sm-6">
            <div class="form-group">
              <label class="control-label">Name</label>
              <input type="text" class="form-control1" required="" value="<?php echo $company->Name ?>" name="Name">
            </div>
            <div class="form-group">
              <label class="control-label">Contact No</label>
              <input type="text" class="form-control1" required="" value="<?php echo $company->ContactNo ?>" name="ContactNo">
            </div>
             <div class="form-group">
              <label class="control-label">Address</label>
              <input type="text" class="form-control1" required="" value="<?php echo $company->Address ?>" name="Address">
            </div>
