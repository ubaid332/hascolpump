...
var detail = new Rickshaw.Graph.HoverDetail({
    graph: graph
          ...
          <!-- map -->
<link href="<?php echo base_url('dist/css/jqvmap.css')?>" rel='stylesheet' type='text/css' />
<script src="<?php echo base_url('dist/js/jquery.vmap.js')?>"></script>
<script src="<?php echo base_url('dist/js/jquery.vmap.sampledata.js')?>" type="text/javascript"></script>
<script src="<?php echo base_url('dist/js/jquery.vmap.world.js')?>" type="text/javascript"></script>
